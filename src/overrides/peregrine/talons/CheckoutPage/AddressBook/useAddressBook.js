...
export const useAddressBook = props => {
    const {
        ...
        toggleActiveContent,
        SetBillingAddressWithAddressId,
    ...
    const [
        ...
        {
            error: setCustomerBillingAddressOnCartError,
            loading: setCustomerBillingAddressOnCartLoading
        }
    ] = useMutation(SetBillingAddressWithAddressId);
    ...
    const isLoading =
        ...
        setCustomerBillingAddressOnCartLoading;
